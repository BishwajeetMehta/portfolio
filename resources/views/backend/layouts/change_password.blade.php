...
<div class="screen-1">
  ...
  <div class="password">
    ...
    <div class="sec-2">
      ...
      <input class="pas" type="password" name="oldpassword" placeholder="Old Password"/>
  ...
  <div class="password">
    ...
    <div class="sec-2">
      <ion-icon name="lock-closed-outline"></ion-icon>
      <input class="pas" type="password" name="newpassword" placeholder="New Password"/>
      <ion-icon class="show-hide" name="eye-outline"></ion-icon>
    </div>
  </div>
  <button class="login">Update Password </button>
